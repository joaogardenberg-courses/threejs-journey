...
void main()
{
    ...
    // Pattern 29
    // float strength = 0.015 / distance(vUv, vec2(0.5)) * 2.0;
    ...
    //     vUv.y
    // );
    // float strength = 0.015 / distance(lightUv, vec2(0.5)) * 2.0;

    // Pattern 31
    // vec2 lightUvX = vec2(vUv.x * 0.2 + 0.4, vUv.y);
    // float lightX = 0.015 / distance(lightUvX, vec2(0.5)) * 2.0;
    // vec2 lightUvY = vec2(vUv.y * 0.2 + 0.4, vUv.x);
    // float lightY = 0.015 / distance(lightUvY, vec2(0.5)) * 2.0;
